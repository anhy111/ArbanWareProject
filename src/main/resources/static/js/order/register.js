$(function(){
    ...
    $('#orderBtn').click(function (){
        ...
        console.log("email : ", email, " name : ", orderer, " ordererPhone : ", ordererPhone, " productName : ", productName, " cartLenth : ", cartLenth,
            " recipient : ", recipient, " recipientPhone : ", recipientPhone, " zipcode : ", zipcode, " city : ", city, " street : ", street, " deliverySave : ", deliverySave
        , " requirements : ", requirements);

        let orderData = {'recipient':recipient, 'phoneNumber':recipientPhone, 'requirements':requirements,
            "address": {
                'zipcode':zipcode,
                'city':city,
                'street':street
